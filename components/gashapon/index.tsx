...
const eggItems = [
  { bg: '/images/gashapon/egg3.png', pos: 'bottom-[0.1em] left-[0.7em] z-[2] rotate-[10deg] scale-110', anim: 'animate-move1' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[-0.1em] left-[1.4em] z-[3] rotate-[-10deg] scale-110', anim: 'animate-move2' },
  { bg: '/images/gashapon/egg5.png', pos: 'bottom-0 right-[0.5em] z-[4] rotate-0 scale-110', anim: 'animate-move3' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[0.6em] left-[0.3em] z-[5]', anim: 'animate-move4' },
  { bg: '/images/gashapon/egg2.png', pos: 'bottom-[0.8em] left-[1em] z-[2] rotate-0 scale-105', anim: 'animate-move5' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[0.75em] left-[1.85em] z-[2] rotate-0 scale-110', anim: 'animate-move6' },
  { bg: '/images/gashapon/egg2.png', pos: 'bottom-[0.75em] right-0 z-[3]', anim: 'animate-move7' },
  { bg: '/images/gashapon/egg4.png', pos: 'bottom-[1.1em] left-[0.2em] z-[2] rotate-[50deg] scale-100', anim: 'animate-move8' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[1.4em] left-[1.1em] z-[1] rotate-[80deg] scale-120', anim: 'animate-move9' },
  { bg: '/images/gashapon/egg4.png', pos: 'bottom-[1.2em] left-[2.1em] z-[0] rotate-[40deg] scale-110', anim: 'animate-move10' },
];
const eggItemsTwo = [
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[0.1em] left-[0.7em] z-[2] rotate-[10deg] scale-110', anim: 'animate-move1' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[-0.1em] left-[1.4em] z-[3] rotate-[-10deg] scale-110', anim: 'animate-move2' },
  { bg: '/images/gashapon/egg3.png', pos: 'bottom-0 right-[0.5em] z-[4] rotate-0 scale-110', anim: 'animate-move3' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[0.6em] left-[0.3em] z-[5]', anim: 'animate-move4' },
  { bg: '/images/gashapon/egg3.png', pos: 'bottom-[0.8em] left-[1em] z-[2] rotate-0 scale-105', anim: 'animate-move5' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[0.75em] left-[1.85em] z-[2] rotate-0 scale-110', anim: 'animate-move6' },
  { bg: '/images/gashapon/egg3.png', pos: 'bottom-[0.75em] right-0 z-[3]', anim: 'animate-move7' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[1.1em] left-[0.2em] z-[2] rotate-[50deg] scale-100', anim: 'animate-move8' },
  { bg: '/images/gashapon/egg.png', pos: 'bottom-[1.4em] left-[1.1em] z-[1] rotate-[80deg] scale-120', anim: 'animate-move9' },
  { bg: '/images/gashapon/egg4.png', pos: 'bottom-[1.2em] left-[2.1em] z-[0] rotate-[40deg] scale-110', anim: 'animate-move10' },
];
// ==================== 模拟函数（保持不变） ====================
const setDocumentTitle = (title: string) =>
  console.log("[mock] setDocumentTitle:", title);
const setUidToken = async (query: Record<string, any>): Promise<string> =>
  "mock-uid-12345";
...
const mockRewardLow = {
  res: [
    {
      id: 1,
      image: "/images/gashapon/gold-web.webp",
      name: "10金币",
      gold: 10,
    },
    {
...
const mockBetResult = (poolLevel: number, times: number) => {
  ...
  return {
    res: {
      ...
      bigResult: {
        isBetBig: isBig,
        image: isBig ? "/images/gashapon/egg5.png" : "",
      },
  ...
  const base: HistoryItem[] = [
    {
      ts: Date.now() - 3600000,
      ptype: 1,
      list: [{ image: "/images/gashapon/fragment.png", winNum: 2 }],
      bigResult: { isBetBig: false, image: "" },
    },
    {
      ts: Date.now() - 7200000,
      ptype: 2,
      list: [{ image: "/images/gashapon/fragment.png", winNum: 1 }],
      bigResult: { isBetBig: true, image: "/images/gashapon/egg5.png" },
    },
  ];
...
const mockExHistory = {
  res: {
    list: [
      {
        ts: Date.now() - 1800000,
        image: "/images/gashapon/fragment.png",
        count: 2,
      },
    ],
    hasMore: false,
...
const Gashapon: React.FC<GashaponProps> = (props) => {
  ...
  const [bigPrizeImage, setBigPrizeImage] = useState<string | StaticImageData>(
    egg5Png,
  );
  ...
  const isShowShop = useCallback(
    (val: number, img: string | StaticImageData, id: number, price: number) => {
      setShopReminder(val);
  ...
  const onChangeIsShowResult = useCallback(
    (val: boolean) => setIsShowResult(val),
    [],
  );
  ...
  const renderItemImage = (
    ...
    const isFragment =
      typeof imgSrc === "string" ? imgSrc.includes("egg_fragment") : false;
    return (
      <Image
        src={imgSrc}
        alt="item"
    ...
    <div className="w-full h-[1.28em] bg-gradient-to-b from-[#402BF9] via-[#5C0DF8] to-[#007BE1] flex justify-between items-center">
      <div className="flex flex-col ml-[0.32em]">
        ...
        <div className="h-[0.4em] leading-[0.4em] flex bg-[rgba(34,26,169,0.61)] rounded-[0.2em] text-center mt-[0.11em]">
          ...
          <div
            className="text-[0.2em] text-[#F5E78B] mx-[0.06em] px-[0.08em]"
            onClick={() => onChangeFuncState(5)}
          >
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          <div className="w-[0.96em] h-[0.96em] relative mx-[0.12em]">
            ...
            {bigPrizeImage && (
              <Image
                className="w-[0.7em] h-[0.7em] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[52%] rounded-full z-20"
                src={egg5Png}
                alt="grand prize"
                priority
              />
          ...
          <div className="flex flex-col items-center">
            <div
              className="text-[#F5E78B] text-[0.2em] mb-[0.1em] text-center"
              dangerouslySetInnerHTML={{ __html: lang.jackPotPro }}
            ></div>
        ...
        <div
          className="w-[0.42em] h-[0.42em] bg-[url('/images/gashapon/question.png')] bg-cover mx-[0.1em]"
          onClick={() => onChangeFuncState(4)}
        ></div>
        <div
          className="w-[0.5em] h-[0.5em] bg-[url('/images/gashapon/close.png')] bg-cover mx-[0.2em]"
          onClick={closeWebviewShow}
        ></div>
      </div>
    </div>
  );
  ...
  const gashaponContentMainComp = () => (
    <div className="w-full h-[9.8em] bg-[url('/images/gashapon/bg.png')] bg-cover overflow-hidden relative">
      {handFirstShow && (
        <div
          className="w-[1em] h-[1em] absolute bottom-[-0.2em] right-[1.2em] bg-[url('/images/gashapon/hand.png')] bg-cover z-[5]   animate-hand"
          onClick={() => {
            setIsStart(!isStart);
            onSwitch();
          }}
      ...
      <div className="w-full h-[8.54em] bg-[url('/images/gashapon/gashapon.png')] bg-cover relative z-[2]">
        <div
          className="w-[3.525em] h-[1.65em] bg-[url('/images/gashapon/rule.png')] bg-cover absolute top-[0.28em] right-[-0.2em] flex justify-center items-center text-center text-[0.28em] text-white"
          onClick={() => onChangeFuncState(2)}
        >
          {lang.rule}
        </div>
        <div className="w-[0.91em] h-[1.11em] bg-[url('/images/gashapon/shop.png')] bg-cover absolute top-[1.2em] right-0 text-center text-white">
          <span
            className="text-[0.24em] block w-full absolute bottom-[0.1em] left-1/2 -translate-x-1/2"
            onClick={() => onChangeFuncState(3)}
          >
            {lang.shop}
          </span>
        </div>
        <div
          className="h-[0.5em] leading-[0.5em] text-[0.28em] text-white absolute bottom-[35%] left-1/2 -translate-x-1/2 text-shadow-[0_0_0.1em_yellow]"
          onClick={() => onChangeFuncState(6)}
        >
          {lang.goodsList}
        </div>
          ...
          <div className="w-[2.71em] h-[0.71em] bg-[url('/images/gashapon/gold_bg.png')] bg-cover flex justify-center items-center">
            <div className="w-full flex justify-between items-center px-3">
              <div className="flex justify-between items-center">
                ...
                <div className=" text-[0.26em] text-white  font-adobe truncate mx-1">
                  {userGold}
                </div>
              </div>
              <div
                className="w-[0.38em] h-[0.38em] bg-[url('/images/gashapon/add.png')] bg-cover"
                onClick={jumpToWallet}
              ></div>
            </div>
          </div>
          <div
            className="w-[4.275em] h-[1.775em] bg-[url('/images/gashapon/record.png')] bg-cover flex justify-center items-center text-white text-[0.28em]"
            onClick={() => onChangeFuncState(1)}
          >
            {lang.record}
          </div>
        </div>
        {/* 10 次按钮 */}
        <div
          className={`w-[5.1em] h-[1.725em] bg-cover flex flex-col justify-center items-center text-[0.28em] text-white absolute bottom-[9%] left-[33%] leading-[0.3em] ${times === 10 ? "bg-[url('/images/gashapon/prize_active.png')] text-shadow-[0_0_0.1em_red] animate-[beBig1_0.4s_linear]" : "bg-[url('/images/gashapon/prize_default.png')] text-shadow-[0_0_0.1em_#0061D3]"}`}
        ...
        >
          ...
          <span className="text-[0.19em] flex justify-center items-center">
            ...
            <Image
              src={"/images/gashapon/gold.png"}
              alt="gold"
              width={20}
              height={20}
              className="inline-block align-middle w-[0.2em] h-[0.2em]"
            />
            )
          </span>
        </div>
        {/* 50 次按钮 */}
        <div
          className={`w-[5.1em] h-[1.725em] bg-cover flex flex-col justify-center items-center text-[0.28em] text-white absolute bottom-[1%] left-[33%] leading-[0.3em] ${times === 50 ? "bg-[url('/images/gashapon/prize_active.png')] text-shadow-[0_0_0.1em_red] animate-[beBig1_0.4s_linear]" : "bg-[url('/images/gashapon/prize_default.png')] text-shadow-[0_0_0.1em_#0061D3]"}`}
...
{/* 💡 外层父级：固定在左下角出蛋口的黑色投影底盘 */}
<div className="w-[1.1em] h-[1.1em] absolute bottom-[0.4%] left-[14.2%]  rounded-full  overflow-hidden ">
  {/* 💡 内层子级：只有当 isFall 为 true 时才挂载，并且执行你之前测试成功的纯正 Tailwind 动画 */}
    <div
      className={`${isFall ? 'animate-egg-fall' : ''}  ${isShake ? 'animate-shake' : ''}  -translate-y-[1.24em]    w-[1.1em] h-[1.1em] bg-no-repeat bg-cover ${
        eggColor === "egg-gold"
          ? "bg-[url('/images/gashapon/egg.png')]"
          : eggColor === "egg-purple"
            ? "bg-[url('/images/gashapon/egg5.png')]"
            : "bg-[url('/images/gashapon/egg2.png')]"
      }`}
    ></div>
</div>
        <div
  className={`w-[1.08em] h-[1.08em] bg-[url('/images/gashapon/switch.png')] bg-cover absolute bottom-[-0.2%] right-[20.9%] rounded-full ${isSwitch ? 'animate-switch-anim' : 'animate-heart-beat'}`}
  onClick={onSwitch}
></div>
      </div>
      {/* 蛋列表 1 */}
      <div
        className={`w-[3.8em] h-[3.8em] absolute top-[20%] left-1/2 -translate-x-1/2 ${poolLevel === 1 ? "animate-[fade_0.5s_linear]" : "hidden"}`}
      >
        {eggItems.map((item, i) => (
  <div
    key={i}
    className={`w-[1.06em] h-[1.06em] bg-no-repeat bg-cover absolute ${
      isStart ? `${item.anim} z-[5]` : item.pos
    }`}
  ...
  ></div>
      ...
      {/* 蛋列表 2 */}
     <div
        className={`w-[3.8em] h-[3.8em] absolute top-[20%] left-1/2 -translate-x-1/2 ${poolLevel === 2 ? "animate-[fade_0.5s_linear]" : "hidden"}`}
      >
        {eggItemsTwo.map((item, i) => (
  <div
    key={i}
    className={`w-[1.06em] h-[1.06em] bg-no-repeat bg-cover absolute ${
      isStart ? `${item.anim} z-[5]` : item.pos
  ...
  ></div>
      ...
      <div
        className={`w-[0.57em] h-[1.07em] bg-[url('/images/gashapon/bar.png')] bg-cover absolute bottom-[30%] right-[9%] z-[1] rotate-[5deg] origin-[10%_90%] ${isSwitch ? "animate-[switch2_1s_linear]" : ""}`}
  ...
  const popUpTitleComp = () => {
    ...
    return (
      <div className="absolute top-[-1em] left-1/2 -translate-x-1/2 w-[4.18em] h-[1.73em] bg-[url('/images/gashapon/title.png')] bg-cover text-white text-[0.29em] text-center leading-[2.1em] text-shadow-[0_0_0.1em_#513DDC]">
        {titles[funcState] || ""}
      </div>
    );
  };
  ...
  const recordComp = () => (
    <div className="px-[0.3em] pt-[0.7em] pb-0">
      ...
      <div className="h-[4.2em] overflow-y-scroll scrollbar-none">
        {historyList.map((item, index) => (
          <div key={index} className="flex flex-col mt-[0.2em] first:mt-0">
            <div className="text-[#9280FF] my-[0.14em] text-center flex justify-center items-center">
              <div className="text-[0.22em] pt-[0.05em]">
                {unix2date6(item.ts, false)}
              </div>
              {item.ptype === 1 ? (
                <div className="flex justify-center items-center mx-[0.1em] text-[0.2em] text-[#ddd]">
                  ({lang.poolL})
                </div>
              ) : (
                <div className="flex justify-center items-center mx-[0.1em] text-[0.2em] text-yellow-300">
                  ({lang.poolH})
                </div>
              )}
            </div>
            <div className="[&_.re-td]:h-[0.8em] [&_.re-td]:flex [&_.re-td]:justify-around [&_.re-td]:items-center [&_.re-td]:border-[0.015em] [&_.re-td]:border-[#7533EC]">
              <div className="re-td h-[0.6em] bg-[#5512D0] rounded-tl-[0.15em] rounded-tr-[0.15em]">
                <div className="flex-1 text-center text-[0.24em] text-white">
                  {lang.goods}
                </div>
              ...
              {item.bigResult.isBetBig && item.bigResult.image && (
                <div className="re-td-big h-[0.9em] bg-[rgba(0,0,0,0.3)] flex justify-around items-center border-[0.015em] border-[#7533EC]">
                  <div className="flex-1 flex justify-center items-center relative">
                    ...
                    <Image
                      src={item.bigResult.image}
                      alt="prize"
                      className="w-[0.58em] h-[0.58em] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2]"
                    />
                  </div>
                  <div className="w-[0.015em] h-full bg-[#7533EC]"></div>
                  <div className="flex-1 text-center text-[0.24em] text-[#F5E78B] font-bold">
                    1
                  </div>
                </div>
              )}
              {item.list.map((subItem, idx) => (
                <div
                  key={idx}
                  className="re-td flex justify-around items-center border-[0.015em] border-[#7533EC]"
                >
                  <div className="flex-1 flex justify-center items-center">
                    {renderItemImage(subItem.image, true)}
                  </div>
                  <div className="w-[0.015em] h-full bg-[#7533EC]"></div>
                  <div className="flex-1 text-center text-[0.28em] text-white">
                    {subItem.winNum}
                  </div>
                </div>
              ))}
        ...
        {isMore ? (
          <div
            className="flex justify-center items-center text-[0.24em] text-white pt-[0.2em]"
            onClick={() => getMore(1)}
          >
            {lang.seeMore}
            {moreloading && (
              <div className="ml-[0.03em] mt-[0.05em]">
                <Image
                  src="/images/gashapon/loading.gif"
                  alt="loading"
                  width={16}
                  height={16}
                  className="w-[0.25em] h-[0.25em]"
                />
              </div>
            )}
          </div>
        ) : (
          <div className="text-[0.2em] text-center text-[#aaa] mt-[0.2em]">
            {lang.noMore}
          </div>
        )}
      </div>
  ...
  const ruleComp = () => (
    <div
      className="px-[0.3em] pt-[0.7em] text-[0.24em] text-white leading-[0.48em]"
      style={{ display: funcState === 2 ? "block" : "none" }}
    >
      <div
        className="h-[4.8em] overflow-y-scroll"
        dangerouslySetInnerHTML={{ __html: lang.ruleTxt }}
      ></div>
    </div>
  );
  ...
  const shopComp = () => (
    <div
      className="px-[0.3em] pt-[0.7em]"
      style={{ display: funcState === 3 ? "block" : "none" }}
    >
          ...
          <div className="mx-[0.1em] text-[0.26em] flex justify-center items-center">
            ...
            {chip === -1 ? (
              <Image
                ...
                width={16}
                height={16}
                className="w-[0.3em] h-[0.3em] inline"
              />
            ) : (
              chip
            )}
      ...
      <div className="h-[4em] mt-[0.2em] overflow-y-scroll flex justify-around flex-wrap">
        {shopList.map((item) => (
          <div
            key={item.itemId}
            className="w-[1.48em] h-[1.9em] rounded-[0.1em] border-[0.01em] border-[#7058F9] bg-[#5512D0] m-[0.2em] flex flex-col"
            onClick={() =>
              isShowShop(1, item.image, item.eggShopid, item.price)
            }
          >
      ...
      <div
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[3.5em] bg-[rgba(0,0,0,0.6)] rounded-[0.1em] z-[901] flex flex-col border-[0.02em] border-[#7E5EFD] ${shopReminder !== 0 ? "animate-[beBig2_0.4s_linear]" : ""}`}
      ...
      >
        <div className="w-full h-[2.5em] relative flex-9 my-[0.2em] mt-[0.3em]">
          {shopGiftImage && (
            <Image
              src={shopGiftImage}
              alt="gift to exchange"
              className="w-[1.5em] h-[1.5em] mx-auto"
            />
          )}
        </div>
        <div className="w-[90%] mx-auto py-[0.2em] text-center text-white text-[0.21em]">
          {lang.isExchange}
        </div>
        <div className="flex justify-around items-center text-center w-full bg-[#5512D0] rounded-b-[0.1em] h-[0.5em] text-white">
          <div
            className="flex-1 flex justify-center items-center h-[0.5em] border-t-[0.01em] border-[#7E5EFD] text-[0.22em]"
            onClick={() => isShowShop(0, "", 0, 0)}
          >
            {lang.no}
          </div>
  ...
  const prizeRuleComp = () => (
    <div
      className="px-[0.3em] pt-[0.7em] text-[0.24em] text-white leading-[0.48em]"
      style={{ display: funcState === 4 ? "block" : "none" }}
    >
      <div
        className="h-[5em] overflow-y-scroll"
        dangerouslySetInnerHTML={{ __html: lang.prizeRuleTxt }}
      ></div>
    </div>
  );
      ...
      >
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="w-[2.5em] h-[2.5em] absolute z-10">
            {bigPrizeImage && (
              <Image src={egg5Png} alt="big prize" className="w-full h-full" />
            )}
          </div>
        </div>
        <div className="absolute top-[15%] left-1/2 -translate-x-1/2 text-white text-[0.7em] text-shadow-[0_0_0.1em_yellow]">
          {lang.congratulate}
        </div>
      </div>
    );
 ...
 console.log(isFall);
  ...
  return (
    <>
      <div
        className={`w-full relative overflow-hidden ${language === "ar" ? "rtl" : ""}`}
        style={{ fontSize: "clamp(50px, 10vw, 100px)" }}
      >
        <div
          className={`${playMusic ? "animate-[xz_10s_linear_infinite]" : ""} absolute right-[3%] top-[15%] z-10 rounded-full flex justify-center items-center`}
          style={{
            boxShadow: "0 0 0.3em 0.05em #000",
            width: "0.7em",
            height: "0.7em",
          }}
        >
          <Image
            src={playMusic ? musicOn : musicOff}
            alt="music icon"
            width={70}
            height={70}
        ...
        <ToastColor
          color={popUpColor}
          ref={toastRef}
          toastContent={popUpTips}
        />

        <div
          className="w-full h-full bg-transparent absolute top-0 left-0 z-[999]"
        ...
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[900] w-[5.8em] h-[5.91em] bg-[#4104B0] border-[0.06em] border-[#7E5EFD] rounded-[0.4em] ${funcState !== 0 ? "animate-[beBig2_0.4s_linear]" : ""}`}
          style={{ display: funcState !== 0 ? "block" : "none" }}
        >
          <div
            className="w-[0.56em] h-[0.56em] bg-[url('/images/gashapon/close.png')] bg-cover absolute right-0 -top-[0.35em]"
            onClick={() => onChangeFuncState(0)}
          ></div>
          {popUpTitleComp()}
          ...
          <RewardView
            ...
            changePoolLevel={(val: number, bool: boolean) =>
              changePoolLevel(val, bool)
            }
          />
        </div>
        ...
        <RankView
          ...
          prizeImage={bigPrizeImage}
        />
        <ResultPopUp
          lang={lang}
          isShowResult={isShowResult}
          onChangeIsShowResult={() => onChangeIsShowResult(false)}
          resultList={resultList}
        />
        {prizePopUpComp()}
        <div className="animate-test-red  w-[1.06em] h-[3.06em] bg-no-repeat bg-cover absolute" style={{backgroundColor:"red"}}></div>
        <div
          className="w-full h-full bg-[rgba(0,0,0,0.64)] absolute top-0 left-0 z-[800]"
          style={{
            display: funcState !== 0 || isShowResult ? "block" : "none",
          }}
        ></div>
      </div>
    </>
